...
class GaussianDreamer(BaseLift3DSystem):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # )
        # ---------------------------新增----------------------------
        guidance_eval = False # 没有写eval的代码
        ...
        with torch.no_grad():
            ...
            if self.true_global_step < 900: # 15000
                ...
                if self.true_global_step > 300 and self.true_global_step % 100 == 0: # 500 100
                    ...
                    self.gaussian.densify_and_prune(0.0002 , 0.05, self.cameras_extent, size_threshold, max_densify_percent)
    ...
    def configure_optimizers(self):
        ...
        checkpoint = "/home/project/gaussian-splatting/output/bear/chkpnt30000.pth"
