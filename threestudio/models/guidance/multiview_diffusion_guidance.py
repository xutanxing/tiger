...
class MultiviewDiffusionGuidance(BaseModule):
    ...
    def configure(self) -> None:
        ...
        config = OmegaConf.load("/home/project/MVDream/mvdream/configs/sd-v2-base.yaml")
        self.model = instantiate_from_config(config.model)
        self.model.load_state_dict(torch.load("/home/project/MVDream/model/sd-v2.1-base-4view.pt", map_location='cpu'))
    ...
    def forward(
        ...
        c2w: Float[Tensor, "B 4 4"] = None, # 相机位姿
        **kwargs,
    ):
